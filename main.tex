...
\paragraph{Bilan de quantité de mouvement: } On choisit d'inclure le tuyau dans le système étudié. On note $\vec{p}$ la quantité de mouvement. A la date $t$ et à la date $t+dt$ on a::
